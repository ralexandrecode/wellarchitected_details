# Princípios de Design e Práticas Recomendadas do AWS Well-Architected 📒
...
## **Objetivo:**
### Este documento tem o objetivo de ajudar estudantes a melhorar a compreensão dos conceitos para realização do exame SAA-C03.
